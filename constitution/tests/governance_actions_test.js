...
const source = fs.readFileSync(path.join(__dirname, '../actions.js'), 'utf8');
const resolveSource = fs.readFileSync(path.join(__dirname, '../resolve.js'), 'utf8').replace(/^export /gm, '');
